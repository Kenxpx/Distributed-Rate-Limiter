...
1. **Image Pull Errors**
   ...
   docker pull ghcr.io/kenxpx/distributed-rate-limiter:latest
...
kubectl set image deployment/rate-limiter rate-limiter=ghcr.io/kenxpx/distributed-rate-limiter:v1.2.3 -n rate-limiter
