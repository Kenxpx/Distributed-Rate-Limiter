...
services:
  ...
  rate-limiter:
    image: ghcr.io/kenxpx/distributed-rate-limiter:1.0.0
...
2. Or manually: `docker run -p 8080:8080 ghcr.io/kenxpx/distributed-rate-limiter:1.0.0`
...
```bash
# Download and run
wget https://github.com/Kenxpx/Distributed-Rate-Limiter/releases/download/v1.2.0/distributed-rate-limiter-1.2.0.jar
java -jar distributed-rate-limiter-1.2.0.jar
```

### Docker
```bash
docker run -p 8080:8080 ghcr.io/kenxpx/distributed-rate-limiter:1.0.0
```
...
echo "1. Go to: https://github.com/Kenxpx/Distributed-Rate-Limiter/releases"
